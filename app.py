...
st.write("" 
         Este gráfico muestra la proyección presupuestal de cada una de las dependencias del estado colombiano con base en el Programa Anteproyecto 2026 realizado por el Ministerio de Hacienda y Crédito Público de Colombia el 4 de abril del 2025.
